        ...
        >
            ...
            <View className="rounded-lg bg-background p-6">
                ...
                <Text className="mt-2 text-base text-gray-700 dark:text-white">
                    <Text className="font-semibold"> 14-Day Free Trial</Text> –
                ...
                <View className="mt-4 gap-3">
                    <Text className="text-base text-gray-700 dark:text-white">
                        ...
                        Gain more visibility, accept priority bookings, and
                        access advanced client management tools.
                    </Text>
                    ...
                    <Text className="mt-2  text-base text-gray-700 dark:text-white">
                        ...
                        Track your earnings, manage your schedule, and boost
                        your appointments with advanced analytics.
                    </Text>
