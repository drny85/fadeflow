      ...
      <Container>
         ...
         <ScrollView className="flex-1 bg-background p-2">
            ...
            <Text style={styles.text}>
               This Privacy Policy outlines how {Constants.expoConfig?.name}{' '}
               collects, uses, and protects your personal information. By using
               our app, you consent to the data practices described in this
               policy.
            </Text>
            ...
            <Text style={styles.text}>
               ...
               you create an account, book a service, or communicate with us.
               This includes your name, email address, phone number, payment
               information, and service preferences.
            </Text>
            ...
            <Text style={styles.text}>
               ...
               facilitating payments, communicating with you, and personalizing
               your experience.
            </Text>
            ...
            <Text style={styles.text}>
               ...
               information with payment processors or service providers who
            ...
            <Text style={styles.text}>
               ...
               significant changes. Your continued use of the app after any
