      ...
      <Container>
         ...
         <ScrollView className="flex-1 bg-background p-2">
            ...
            <Text style={styles.text}>
               ...
               use our app. By accessing or using our services, you agree to the
            ...
            <Text style={styles.text}>
               ...
               when you create an account, book an appointment, or communicate
               with us. This information may include your name, email address,
               phone number, payment details, and service preferences.
            </Text>
            ...
            <Text style={styles.text}>
               ...
               {'\n'}- Send you updates and promotional offers (you can opt-out
               at any time)
            </Text>
            ...
            <Text style={styles.text}>
               ...
               help us operate our app and deliver services to you, such as
               payment processors and customer support teams. We ensure that
               these parties adhere to strict data protection standards.
            </Text>
            ...
            <Text style={styles.text}>
               ...
               or misuse. However, please note that no method of transmitting
               data over the internet or storing electronic data is completely
               secure.
            </Text>
            ...
            <Text style={styles.text}>
               ...
               your experience on our app. These technologies help us understand
               how you use our services, personalize your experience, and
               deliver relevant advertisements. You can manage your cookie
