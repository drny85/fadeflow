         ...
         <ScrollView
            ...
            <GooglePlacesAutocomplete
               ...
               onPress={(data, details = null) => {
                  ...
                  const state = formatted_address.split(', ')[2].split(' ')[0].trim();
                  const zip = formatted_address.split(', ')[2].split(' ')[1].trim();
                  setValue('address', formatted_address);
                  setValue('city', city);
                  setValue('state', state);
                  setValue('zip', zip);
                  setValue('coords', { lat: location.lat, lng: location.lng });
               }}
               debounce={500}
               fetchDetails={true}
               query={{ key: GOOGLE_KEY, language: 'en', components: 'country:us' }}
