    ...
    const calculateEarnings = () => {
        ...
        appointments.forEach((appointment) => {
            ...
            if (isSameDay(appointmentDate, today)) {
                ...
                earnings.Today[hour] =
                    (earnings.Today[hour] || 0) + totalEarnings
            }
        ...
        setEarningsData({
            Today: Object.entries(earnings.Today).map(([label, value]) => ({
                label,
                value
            })),
            WTD: Object.entries(earnings.WTD).map(([label, value]) => ({
                label,
                value
            })),
            YTD: Object.entries(earnings.YTD).map(([label, value]) => ({
                label,
                value
            })),
            ALL: Object.entries(earnings.ALL).map(([label, value]) => ({
                label,
                value
            }))
        })
