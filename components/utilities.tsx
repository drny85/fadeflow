            ...
            return (
                <View className="gap-3">
                    ...
                    <View className="flex-row">
                        <Text className="w-6 text-center text-muted-foreground">
                            ·
                        </Text>
                        <View className="flex-1">
                            ...
                            >
                                Don't call StoreReview.requestReview() from a
                                button
                            </Text>
                        </View>
                    </View>
                    <View className="flex-row">
                        ...
                        <View className="flex-1">
                            <Text
                                ...
                                className="text-muted-foreground"
                            >
                                Don't request a review when the user is doing
                    ...
                    <View className="flex-row">
                        ...
                        <View className="flex-1">
                            <Text
                                ...
                                className="text-muted-foreground"
                            >
                                Don't ask the user any questions before or while
                        ...
                        onPress={async () => {
                            try {
                                const result = await Share.share({
                                    message:
                                        'NativeWindUI | Familiar interface, native feel.'
                                })
